...
# print(aesCbc.aesEnc("1234567890abcabc","4"*16))

def equalBlocks(text,blockSize):
    count = 0
    a = len(text)
    for i in range(0,a,blockSize):
        for j in range(0, a, blockSize):
            if(j==i):
                continue
